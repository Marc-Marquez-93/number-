CREATE DATABASE  IF NOT EXISTS `numerologia` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `numerologia`;
-- MySQL dump 10.13  Distrib 8.0.42, for Win64 (x86_64)
--
-- Host: localhost    Database: numerologia
-- ------------------------------------------------------
...
CREATE TABLE `lecturas` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_lecturas_usuario` (`usuario_id`),
...
CREATE TABLE `pagos` (
  ...
  CONSTRAINT `fk_pagos_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-11-10 21:53:28
